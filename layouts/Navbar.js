...
const Navbar = () => {
   ...
   return (
      <nav
         id="navbar"
         className="bg-white/75 px-2 sm:px-4 border-b border-gray-100 dark:border-gray-800 py-2.5 dark:bg-gray-900/75 backdrop-blur-lg shadow-sm z-30 sticky top-0 w-full"
      >
