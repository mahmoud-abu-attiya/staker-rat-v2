...
export default function Home() {
   return (
      <div className="overflow-hidden">
         ...
         <div
            className="container grid place-content-center gap-8 min-h-screen"
         >
            <h1 className="text-slate-900 drop-shadow-md font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-center dark:text-white">
               ...
               make your friends frank you what you don't know about yourself.
            </h1>
            <p className="mt-6 text-lg text-slate-600 text-center max-w-3xl mx-auto dark:text-slate-400">
					Stalker Rat helps you to identify your
                <span className="ont-mono font-medium text-sky-500 dark:text-sky-400"> disadvantages </span> and <span className="ont-mono font-medium text-sky-500 dark:text-sky-400"> advantages </span> by obtaining criticism from your
